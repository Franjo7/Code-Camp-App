  ...
  return (
    <div className="container">
      <div className="max-w-7xl">
        <h1 className="text-5xl font-bold mb-8 text-center text-white">About Us</h1>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="col-span-2">
            <h2 className="text-4xl font-semibold mb-4 text-white">Our Values</h2>
          ...
          <div className="col-span-2">
            <h2 className="text-4xl font-semibold mb-4 text-white">Company Overview</h2>
            <p className="text-lg text-gray-300">
              <span className="font-bold">GlobalSoft</span> was founded in <span className="font-bold">2016</span> with headquarters in <span className="font-bold">Široki Brijeg</span> and operates as part of the <span className="font-bold">German group Daniel Speyer GmbH</span>. We generate most of our income in the foreign market, mainly in the countries of the European Union.
            </p>
            <p className="text-lg text-gray-300">
