      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          ...
          <div className="flex flex-col justify-center items-center bg-gray-800 p-8 rounded-lg">
            ...
            <p className="text-lg text-gray-300">
              If you already know that you want to join our Code Camp, you can register right away. Just click on the <a href="/register" className="underline text-white">Register</a> link and fill out the form. We are looking forward to welcoming you.
            </p>
          </div>
        </div>
      </div>
